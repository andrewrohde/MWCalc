...
public class InterfaceUI extends Activity {
    ...
    public void mShowSettings() {
        ...
        Intent Preferences = new Intent(getBaseContext(), com.madwindevelopers.mwcalc.PreferencesUI.class);
    ...
    public void mShowHelp() {
        Intent Help = new Intent(getBaseContext(), com.madwindevelopers.mwcalc.HelpUI.class);
